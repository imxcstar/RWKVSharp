...
class RWKVOnnxOps():
    ...
    def __init__(self, layers, embed, opsVersion = 15, externalData = True, splitExternalData = False,fp32inout=True, quantized = False, *args, dtype=None, heads=32,cname='RWKV', **kwargs):
        import onnx
        ...
        self.nm = 0
        exportname = f"{cname}_{layers}_{embed}_{'32' if dtype == onnx.TensorProto.FLOAT else '16'}_{opsVersion}.onnx"
        externalname = f"{cname}_{layers}_{embed}_{'32' if dtype == onnx.TensorProto.FLOAT else '16'}_{opsVersion}"
